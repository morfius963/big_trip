...
/* harmony import */ var _model_point_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./model-point.js */ "./src/js/model-point.js");
...
class API {
  ...
  getPoints() {
    return this._load({url: `points`})
      .then(API.toJSON)
      .then(_model_point_js__WEBPACK_IMPORTED_MODULE_0__["default"].parsePoints);
  }
  ...
  createPoint({point}) {
    return this._load({
      ...
      .then(API.toJSON)
      .then(_model_point_js__WEBPACK_IMPORTED_MODULE_0__["default"].parsePoint);
  }
...
/***/ "./src/js/components/edit-event.js":
/*!*****************************************!*\
  !*** ./src/js/components/edit-event.js ***!
  \*****************************************/
/*! exports provided: default */
...
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./abstract-component.js */ "./src/js/components/abstract-component.js");




class EditEvent extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor({id, type: {value, placeholder}, destination: {name, description, pictures}, eventTime: {from, to}, cost, currency, isFavorite, offers}, tripTypes, cities) {
    ...
    this._eventTimeFrom = moment__WEBPACK_IMPORTED_MODULE_1___default()(from);
    this._eventTimeTo = moment__WEBPACK_IMPORTED_MODULE_1___default()(to);
        ...
        <header class="event__header">
          ...
          <div class="event__field-group  event__field-group--destination">
            <label class="event__label  event__type-output" for="event-destination-1">
              ${Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["makeFirstSymUp"])(this._typeValue)} ${this._typePlaceholder}
            </label>
  ...
  resetForm() {
    ...
    this.getElement().querySelector(`.event__type-output`).textContent = `${Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["makeFirstSymUp"])(this._typeValue)} ${this._typePlaceholder}`;
    ...
    this.getElement()
      ...
      .forEach((typeItem) => {
        typeItem.addEventListener(`click`, (evt) => {
          ...
          this.getElement().querySelector(`.event__type-output`).textContent = `${Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["makeFirstSymUp"])(typeData.type)} ${_utils_js__WEBPACK_IMPORTED_MODULE_0__["TRANSPORT_TYPES"].has(typeData.type) ? `to` : `in`}`;
...
class Event extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  ...
  getTemplate() {
    return `<li class="trip-events__item">
      <div class="event">
        ...
        <h3 class="event__title">${Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["makeFirstSymUp"])(this._typeValue)} ${this._typePlaceholder} ${this._city}</h3>
        ...
        <div class="event__schedule">
          ...
          <p class="event__duration">${Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getFormattedTimeDifference"])(this._eventTimeFrom, this._eventTimeTo)}</p>
        </div>
...
/***/ "./src/js/components/events-list.js":
/*!******************************************!*\
  !*** ./src/js/components/events-list.js ***!
  \******************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils.js */ "./src/js/utils.js");
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./abstract-component.js */ "./src/js/components/abstract-component.js");
  ...
  getTemplate() {
    return `<form class="trip-filters" action="#" method="get">
      ${this._filters.map(({name, isChecked}) => `<div class="trip-filters__filter">
        ...
        <label class="trip-filters__filter-label" for="filter-${name}">${Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["makeFirstSymUp"])(name)}</label>
      </div>`).join(``)}
...
class Menu extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  ...
  getTemplate() {
    return `<nav class="trip-controls__trip-tabs  trip-tabs">
      ${this._menuValue.map(({name, isActive}) => `<a class="trip-tabs__btn ${isActive ? `trip-tabs__btn--active` : ``}" href="#" data-switch="${name}">${Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["makeFirstSymUp"])(name)}</a>`).join(``)}
    </nav>`;
  }
}
...
/***/ "./src/js/components/no-points.js":
/*!****************************************!*\
  !*** ./src/js/components/no-points.js ***!
  \****************************************/
/*! exports provided: default */
...
class Statistics extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    ...
    chart_js__WEBPACK_IMPORTED_MODULE_2___default.a.defaults.global.defaultFontColor = `#000000`;
    chart_js__WEBPACK_IMPORTED_MODULE_2___default.a.defaults.global.defaultFontSize = 18;
  }
  ...
  _createTimeChart() {
    ...
    const timeChartData = timeChartLabels.reduce((acc, label) => {
      ...
      const hoursCount = Math.max(MIN_HOURS_COUNT, Math.floor(moment__WEBPACK_IMPORTED_MODULE_1___default.a.duration(labelTime).asHours()));
...
/***/ "./src/js/components/trip-content.js":
/*!*******************************************!*\
  !*** ./src/js/components/trip-content.js ***!
  \*******************************************/
/*! exports provided: default */
...
class TripContent extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/***/ "./src/js/components/trip-day-info.js":
/*!********************************************!*\
  !*** ./src/js/components/trip-day-info.js ***!
  \********************************************/
/*! exports provided: default */
...
class TripDayInfo extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/* harmony default export */ __webpack_exports__["default"] = (TripDayInfo);


/***/ }),

/***/ "./src/js/components/trip-info.js":
/*!****************************************!*\
  !*** ./src/js/components/trip-info.js ***!
  \****************************************/
/*! exports provided: default */
...
class TripInfo extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  setTripInfoData({cities, date: {start, end}}) {
    this.removeElement();
    this._cities = cities;
    this._dateStart = moment__WEBPACK_IMPORTED_MODULE_1___default()(start);
    this._dateEnd = moment__WEBPACK_IMPORTED_MODULE_1___default()(end);
  }
  ...
  static getMockElement() {
    return Object(_utils_js__WEBPACK_IMPORTED_MODULE_2__["createElement"])(`<div class="trip-info__main">
...
/***/ "./src/js/components/trip-item-content.js":
/*!************************************************!*\
  !*** ./src/js/components/trip-item-content.js ***!
  \************************************************/
/*! exports provided: default */
...
class TripItemContent extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    return `<li class="trip-days__item day"></li>`;
  }
}

/* harmony default export */ __webpack_exports__["default"] = (TripItemContent);
...
/* harmony import */ var _components_trip_info_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/trip-info.js */ "./src/js/components/trip-info.js");



class PageDataController {
  constructor() {
    this._newTripinfo = new _components_trip_info_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
  ...
  updatePage(points) {
    ...
    const newTripInfoData = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getTripInfoData"])(sortedPoints);

    this._newTripinfo.setTripInfoData(newTripInfoData);
    this._tripInfoParent.removeChild(tripInfoContainer);
    Object(_utils__WEBPACK_IMPORTED_MODULE_0__["renderElement"])(this._tripInfoParent, this._newTripinfo.getElement(), `afterbegin`);
    this._fullTripPriceElem.textContent = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getFullEventPrice"])(sortedPoints);
  }
}
...
/***/ "./src/js/controllers/point-controller.js":
/*!************************************************!*\
  !*** ./src/js/controllers/point-controller.js ***!
  \************************************************/
...
/* harmony import */ var _components_event_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/event.js */ "./src/js/components/event.js");
/* harmony import */ var _components_edit_event_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/edit-event.js */ "./src/js/components/edit-event.js");
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils.js */ "./src/js/utils.js");
...
class PointController {
  constructor(container, data, mode, onChangeView, onDataChange, types, destinations) {
    ...
    this._event = new _components_event_js__WEBPACK_IMPORTED_MODULE_0__["default"](data);
    this._editEvent = new _components_edit_event_js__WEBPACK_IMPORTED_MODULE_1__["default"](data, types, destinations);
  ...
  init(mode) {
    ...
    flatpickr__WEBPACK_IMPORTED_MODULE_4___default()(this._editEvent.getElement().querySelector(`#event-start-time-1`), {
      allowInput: false,
      defaultDate: moment__WEBPACK_IMPORTED_MODULE_3___default()(this._data.eventTime.from).format(`DD/MM/YY HH:mm`),
      dateFormat: `d/m/y H:i`,
      enableTime: true,
      onChange(selectedDates) {
        if (moment__WEBPACK_IMPORTED_MODULE_3___default()(selectedDates[0]).valueOf() > moment__WEBPACK_IMPORTED_MODULE_3___default()(document.querySelector(`#event-end-time-1`).value, `DD/MM/YY HH:mm`).valueOf()) {
          document.querySelector(`#event-end-time-1`).value = moment__WEBPACK_IMPORTED_MODULE_3___default()(selectedDates[0]).format(`DD/MM/YY HH:mm`);
        }
      }
    });

    flatpickr__WEBPACK_IMPORTED_MODULE_4___default()(this._editEvent.getElement().querySelector(`#event-end-time-1`), {
      allowInput: false,
      defaultDate: moment__WEBPACK_IMPORTED_MODULE_3___default()(this._data.eventTime.to).format(`DD/MM/YY HH:mm`),
      dateFormat: `d/m/y H:i`,
      enableTime: true,
      onChange(selectedDates) {
        if (moment__WEBPACK_IMPORTED_MODULE_3___default()(selectedDates[0]).valueOf() < moment__WEBPACK_IMPORTED_MODULE_3___default()(document.querySelector(`#event-start-time-1`).value, `DD/MM/YY HH:mm`).valueOf()) {
          document.querySelector(`#event-start-time-1`).value = moment__WEBPACK_IMPORTED_MODULE_3___default()(selectedDates[0]).format(`DD/MM/YY HH:mm`);
        }
      }
    });
    ...
    .addEventListener(`click`, () => {
      if (mode === Mode.ADDING) {
        Object(_utils_js__WEBPACK_IMPORTED_MODULE_2__["unrenderElement"])(this._editEvent.getElement());
  ...
  _buildNewData() {
    ...
    const timeFrom = moment__WEBPACK_IMPORTED_MODULE_3___default()(formData.get(`event-start-time`), `DD/MM/YY HH:mm`).valueOf();
    const timeTo = moment__WEBPACK_IMPORTED_MODULE_3___default()(formData.get(`event-end-time`), `DD/MM/YY HH:mm`).valueOf();
...
/***/ "./src/js/controllers/trip-controller.js":
/*!***********************************************!*\
  !*** ./src/js/controllers/trip-controller.js ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_sort_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/sort.js */ "./src/js/components/sort.js");
/* harmony import */ var _components_trip_content_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/trip-content.js */ "./src/js/components/trip-content.js");
/* harmony import */ var _components_trip_item_content_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/trip-item-content.js */ "./src/js/components/trip-item-content.js");
/* harmony import */ var _components_trip_day_info_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/trip-day-info.js */ "./src/js/components/trip-day-info.js");
/* harmony import */ var _components_events_list_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/events-list.js */ "./src/js/components/events-list.js");
/* harmony import */ var _components_no_points_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/no-points.js */ "./src/js/components/no-points.js");
/* harmony import */ var _point_controller_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./point-controller.js */ "./src/js/controllers/point-controller.js");
...
class TripController {
  constructor(container, trips, onDataChange, types, destinations) {
    ...
    this._sort = new _components_sort_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this._tripContent = new _components_trip_content_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._noPoints = new _components_no_points_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
  ...
  init() {
    if (this._trips.length === 0) {
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_8__["renderElement"])(this._container, this._noPoints.getElement(), `beforeend`);

      return;
    }

    Object(_utils_js__WEBPACK_IMPORTED_MODULE_8__["renderElement"])(this._container, this._sort.getElement(), `beforeend`);
  ...
  createTask() {
    ...
    this.onChangeView();
    this._creatingPoint = new _point_controller_js__WEBPACK_IMPORTED_MODULE_6__["default"](newPointContainer, defaultPoint, _point_controller_js__WEBPACK_IMPORTED_MODULE_6__["Mode"].ADDING, this.onChangeView, (...args) => {
      this._creatingPoint = null;
  ...
  onChangeView() {
    ...
    if (allPoints.length > this._trips.length) {
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_8__["unrenderElement"])(allPoints[0]);
      this._creatingPoint = null;
    }
  }
  ...
  _createNewDay() {
    ...
    const tripItemContent = new _components_trip_item_content_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    const tripDayInfo = new _components_trip_day_info_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    const eventsList = new _components_events_list_js__WEBPACK_IMPORTED_MODULE_4__["default"]();

    mainContainer.innerHTML = ``;
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_8__["renderElement"])(mainContainer, this._tripContent.getElement(), `beforeend`);
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_8__["renderElement"])(this._tripContent.getElement(), tripItemContent.getElement(), `beforeend`);
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_8__["renderElement"])(tripItemContent.getElement(), tripDayInfo.getElement(), `beforeend`);
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_8__["renderElement"])(tripItemContent.getElement(), eventsList.getElement(), `beforeend`);
  }

  _renderEvent(eventsContainer, eventData) {
    const pointController = new _point_controller_js__WEBPACK_IMPORTED_MODULE_6__["default"](eventsContainer, eventData, _point_controller_js__WEBPACK_IMPORTED_MODULE_6__["Mode"].DEFAULT, this.onChangeView, this._onDataChange, this._tripTypes, this._destinations);
    this._subscriptions.push(pointController.setDefaultView.bind(pointController));
  }

  _clearAllTrips() {
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_8__["unrenderElement"])(this._tripContent.getElement());
    this._tripContent.removeElement();
  }

  _renderByDays(trips) {
    const sortedFromDates = trips.map(({eventTime: {from}}) => from).sort((a, b) => a - b);
    const formattedDates = sortedFromDates.map((date) => moment__WEBPACK_IMPORTED_MODULE_7___default()(date).format(`MMM DD`));
    const uniqueFormattedDates = [...new Set(formattedDates)];

    Object(_utils_js__WEBPACK_IMPORTED_MODULE_8__["renderElement"])(this._container, this._tripContent.getElement(), `beforeend`);

    uniqueFormattedDates.forEach((eventDate, i) => {
      const tripItemContent = new _components_trip_item_content_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
      const tripDayInfo = new _components_trip_day_info_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
      const eventsList = new _components_events_list_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
      const tripsForOneDay = trips.filter(({eventTime: {from}}) => moment__WEBPACK_IMPORTED_MODULE_7___default()(from).format(`MMM DD`) === eventDate);
      const stringToObjDate = new Date(`${eventDate} ${moment__WEBPACK_IMPORTED_MODULE_7___default()(Date.now()).format(`YYYY`)}`);
      ...
      tripDayInfo.getElement().querySelector(`.day__date`).textContent = moment__WEBPACK_IMPORTED_MODULE_7___default()(stringToObjDate).format(`MMM DD`);
      tripDayInfo.getElement().querySelector(`.day__date`).value = moment__WEBPACK_IMPORTED_MODULE_7___default()(stringToObjDate).format(`YYYY-MM-DD`);
  ...
  _getFilteredTrips() {
    ...
    const tripsFuture = tripsData.filter((trip) => moment__WEBPACK_IMPORTED_MODULE_7___default()(trip.eventTime.from).isAfter(new Date(Date.now())));
    const tripsPast = tripsData.filter((trip) => moment__WEBPACK_IMPORTED_MODULE_7___default()(trip.eventTime.to).isBefore(new Date(Date.now())));
...
class ModelPoint {
  constructor(data) {
    ...
    this.type = {
      value: data[`type`],
      placeholder: _utils_js__WEBPACK_IMPORTED_MODULE_0__["TRANSPORT_TYPES"].has(data[`type`]) ? `to` : `in`
    };
...
/* harmony default export */ __webpack_exports__["default"] = (ModelPoint);
...
class Provider {
  ...
  getPoints() {
    ...
    const rawPoints = Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["objectToArray"])(rawPointsMap);
    const points = _model_point_js__WEBPACK_IMPORTED_MODULE_0__["default"].parsePoints(rawPoints);
  ...
  createPoint({point}) {
    ...
    return Promise.resolve(_model_point_js__WEBPACK_IMPORTED_MODULE_0__["default"].parsePoint(point));
  }
  ...
  updatePoint({id, point}) {
    ...
    return Promise.resolve(_model_point_js__WEBPACK_IMPORTED_MODULE_0__["default"].parsePoint(pointItem));
  }
  ...
  syncPoints() {
    return this._api.syncPoints({points: Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["objectToArray"])(this._store.getAll())});
  }
...
/*!*************************!*\
  !*** ./src/js/utils.js ***!
  \*************************/
/*! exports provided: getRandomNum, makeFirstSymUp, getRandomArray, getFullEventPrice, getFormattedTimeDifference, POSITION, createElement, renderElement, unrenderElement, getTripInfoData, getMenuData, getFilterData, TRANSPORT_TYPES, objectToArray */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRandomNum", function() { return getRandomNum; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "makeFirstSymUp", function() { return makeFirstSymUp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRandomArray", function() { return getRandomArray; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFullEventPrice", function() { return getFullEventPrice; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFormattedTimeDifference", function() { return getFormattedTimeDifference; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTripInfoData", function() { return getTripInfoData; });
...
const makeFirstSymUp = (value) => value === `` ? `` : `${value[0].toUpperCase()}${value.substring(1)}`;
...
const getFullEventPrice = (eventsList) => (
...
const getFormattedTimeDifference = (dateFrom, dateTo) => {
  const diff = dateTo.diff(dateFrom);
  const duration = moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(diff);
...
const TRANSPORT_TYPES = new Set([`taxi`, `bus`, `train`, `ship`, `transport`, `drive`, `flight`]);
...
/* harmony import */ var _js_components_filters_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/components/filters.js */ "./src/js/components/filters.js");
/* harmony import */ var _js_components_trip_info_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/components/trip-info.js */ "./src/js/components/trip-info.js");
/* harmony import */ var _js_controllers_trip_controller_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./js/controllers/trip-controller.js */ "./src/js/controllers/trip-controller.js");
...
/* harmony import */ var _js_controllers_page_data_controller_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./js/controllers/page-data-controller.js */ "./src/js/controllers/page-data-controller.js");
/* harmony import */ var _js_api_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./js/api.js */ "./src/js/api.js");
/* harmony import */ var _js_provider_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./js/provider.js */ "./src/js/provider.js");
/* harmony import */ var _js_store_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./js/store.js */ "./src/js/store.js");
/* harmony import */ var _js_utils_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./js/utils.js */ "./src/js/utils.js");
...
const menuData = MENU_VALUES.map(_js_utils_js__WEBPACK_IMPORTED_MODULE_10__["getMenuData"]);
const filtersData = FILTER_VALUES.map(_js_utils_js__WEBPACK_IMPORTED_MODULE_10__["getFilterData"]);

let tripController = null;
const pageDataController = new _js_controllers_page_data_controller_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
const menu = new _js_components_menu_js__WEBPACK_IMPORTED_MODULE_0__["default"](menuData);
const filters = new _js_components_filters_js__WEBPACK_IMPORTED_MODULE_1__["default"](filtersData);
const tripInfo = new _js_components_trip_info_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
const statistics = new _js_components_statistics_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
const loadingMessage = new _js_components_loading_message_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
const api = new _js_api_js__WEBPACK_IMPORTED_MODULE_7__["default"](END_POINT, AUTHORIZATION);
const store = new _js_store_js__WEBPACK_IMPORTED_MODULE_9__["default"]({storage: window.localStorage, key: POINTS_STORE_KEY});
const provider = new _js_provider_js__WEBPACK_IMPORTED_MODULE_8__["default"]({api, store, generateId: () => String(Date.now())});

if (!_js_provider_js__WEBPACK_IMPORTED_MODULE_8__["default"].isOnline()) {
...
provider.getData({url: `offers`, key: `offers`})
  ...
  .then((points) => {
    tripsData = points;
    tripInfoData = Object(_js_utils_js__WEBPACK_IMPORTED_MODULE_10__["getTripInfoData"])(points.slice().sort((a, b) => a - b));
  })
  .then(() => {
    tripInfo.setTripInfoData(tripInfoData);
    tripController = new _js_controllers_trip_controller_js__WEBPACK_IMPORTED_MODULE_3__["default"](eventsContent, tripsData, onDataChange, tripTypesWithOptions, citiesWithDescription);
  })
  .then(() => {
    Object(_js_utils_js__WEBPACK_IMPORTED_MODULE_10__["unrenderElement"])(loadingMessage.getElement());
    loadingMessage.removeElement();
    tripController.init();
    fullTripPriceElem.textContent = Object(_js_utils_js__WEBPACK_IMPORTED_MODULE_10__["getFullEventPrice"])(tripsData);
    document.querySelector(`.trip-info__main`).replaceWith(tripInfo.getElement());
  });

Object(_js_utils_js__WEBPACK_IMPORTED_MODULE_10__["renderElement"])(tripInfoContainer, _js_components_trip_info_js__WEBPACK_IMPORTED_MODULE_2__["default"].getMockElement(), `afterbegin`);
Object(_js_utils_js__WEBPACK_IMPORTED_MODULE_10__["renderElement"])(menuContainer, menu.getElement(), `afterend`);
Object(_js_utils_js__WEBPACK_IMPORTED_MODULE_10__["renderElement"])(filterContainer, filters.getElement(), `afterend`);
Object(_js_utils_js__WEBPACK_IMPORTED_MODULE_10__["renderElement"])(pageBodyContainer, statistics.getElement(), `beforeend`);
Object(_js_utils_js__WEBPACK_IMPORTED_MODULE_10__["renderElement"])(eventsContent, loadingMessage.getElement(), `beforeend`);
statistics.hide();
